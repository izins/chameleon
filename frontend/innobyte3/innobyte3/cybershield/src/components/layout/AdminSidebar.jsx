...
import { LayoutDashboard, Bell, FileText, PanelLeftClose, PanelLeft, LogOut } from 'lucide-react';
      ...
      <div className="p-3 border-t border-brand-border space-y-2">
        ...
        {!collapsed && (
          <div className="flex items-center gap-3 px-3 py-2">
            <div className="w-8 h-8 rounded-lg bg-brand-primary-dim flex items-center justify-center text-brand-primary text-xs font-bold shrink-0">AD</div>
            <div className="overflow-hidden">
              <p className="text-sm font-medium text-white truncate">Admin Director</p>
              <p className="text-xs text-neutral-500 truncate">CEO / Director</p>
            </div>
          </div>
        )}
